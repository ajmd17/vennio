...
app.controller('LandingPageController', function($scope) {
    $scope.showLoginModal = function() {
        var $loginWindowContent = $('<div>')
            .append($('<div>')
                .addClass('social-login social-login-google')
                .append('<i class="fa fa-google" aria-hidden="true" style="margin-right:4px;">')
                .append('<span class="vr">')
                .append($('<div>')
                    .css({
                        "margin-left": '14px',
                        "display": 'inline'
                    })
                    .append('Log in with Google')))
            .append($('<div>')
                .addClass('social-login social-login-facebook')
                .append('<i class="fa fa-facebook" aria-hidden="true" style="margin-right:4px;">')
                .append('<span class="vr">')
                .append($('<div>')
                    .css({
                        "margin-left": '14px',
                    ...
                    .append('Log in with Facebook')));

        new Modal('Log In', $loginWindowContent, []).show();
    };
